...
#include <conio.h>
                      ...
                      /*********************************************************************************
					  *                               												   *
					  *              Projet by : MARYAM AMZIL AND ASMA ZABAR (Groupe TP: G2a)                *
					  *	                                                                               *                       
					  *********************************************************************************/
 ...
 void EnTete()
{
	...
	printf("\n");
	    ...
	    printf("\n                                                             \xba                                                                  \xba\n");
		printf("                                                             \xba            _____________________                                 \xba\n");
		printf("                                                             \xba     _____/                       -----<---<---<--                \xba\n");
		printf("                                                             \xba    |___ __                          __________--<---<---<--      \xba\n");
	    printf("                                                             \xba           (__)---============---(__)                             \xba\n");
	    printf("                                                             \xba                                                                  \xba");
